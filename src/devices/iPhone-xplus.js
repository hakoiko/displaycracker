export const iPhoneXPlus = {
  name: 'iPhone X Plus', // name of the device.
  manufacturer: 'Apple',
  os: 'ios',
  device: {
    width: 77.4, // device width in mm. physical screen width would calculated from diagonal inch and aspect ratio.
    height: 157.5, // device height in mm.
  ...
  screen: {
    diagonal: 6.5, // diagonal length in inch. all of speification in this document is defined in SI unit. but most of manufacturers are open their screen sizes only in Inch. this is the only one yard/pound unit on this document.
